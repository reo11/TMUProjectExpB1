# -*- coding: utf-8 -*-
"""
Created on Thu Dec  6 15:46:05 2018
...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        # コンボボックス作成
        self.combo_train = QComboBox(self)
        p = Path(os.path.dirname(__file__))
        files = sorted(p.glob("*.py"))
        for filename in files:
            self.combo_train.addItem(filename.name)
        ...
        self.vboxTrain.addWidget(self.combo_train)
